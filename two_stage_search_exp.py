...
if __name__ == '__main__':
    ...
    print(sys.argv)
    main(wb)
    # wb.append('备注', 0, "TwoStageSearch, fraction: 0.1, model: LeNet, dataset: MNIST, last_layer, Info, ratio: 1.0, middle: 动态,min_mmd_distance: 0.01, cosine")
    # wb.to_excel('./excel/data_TwoStageSearch_10_2.xlsx')
    wb.append('备注', 0, "TwoStageSearch, fraction: 0.1, model: ResNet18, dataset: CIFAR10, TwoStageSearch, last_layer, Info, ratio: 1.0, middle: 动态,min_mmd_distance: 0.01, cosine")
    ...
    # wb.to_excel('./excel/data_TwoStageSearch_70_2.xlsx')
    print("end")
