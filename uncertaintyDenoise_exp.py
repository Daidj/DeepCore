...
if __name__ == '__main__':
    ...
    print(sys.argv)
    main(wb)
    wb.append('备注', 0, "uncertaintyDenoise, LeastConfidence, fraction: 0.3, model: ResNet18, dataset:CIFAR10, 去除噪声元素后的样本选择,使用软修剪，比例0.5")
    wb.to_excel('./excel/data_uncertaintyDenoise_LeastConfidence_fraction_05_denoise_30.xlsx')
    print("end")
