...
if __name__ == '__main__':
    ...
    print(sys.argv)
    main(wb)
    # wb.append('备注', 0, "fdmat, fraction: 0.1, model: LeNet, dataset: MNIST")
    # wb.to_excel('./excel/data_fdmat_10_mnist.xlsx')

    wb.append('备注', 0, "fdmat, fraction: 0.1, model: ResNet18, dataset: CIFAR10")
