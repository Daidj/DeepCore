...
if __name__ == '__main__':
    ...
    print(sys.argv)
    main(wb)
    # wb.append('备注', 0, "MMD贪婪算法，fraction: 0.1, model: ResNet18, dataset: CIFAR10")
    wb.append('备注', 0, "MMD贪婪算法，fraction: 0.1, model: LeNet, dataset: MNIST")
    wb.to_excel('./excel/data_MMD_10.xlsx')
