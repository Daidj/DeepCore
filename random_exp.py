...
if __name__ == '__main__':
    ...
    print(sys.argv)
    main(wb)
    # wb.append('备注', 0, "Random, fraction: 0.9, model: ResNet18, dataset: CIFAR100")
    ...
    # wb.append('备注', 0, "fraction: 1.0, TINYMNIST, LeNet")
    # wb.append('备注', 0, "fraction: 1.0, NewsGroups, TextCNN")
    # wb.append('备注', 0, "fraction: 0.1, ESC50, TDNN")
