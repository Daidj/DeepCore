...
from .moea_d_ldea_new import SubProblems, Individual, plot_nested_list
...
class MOEAD_SE(EarlyTrain):
    ...
    def finish_run(self):
        ...
        if self.balance:
            ...
            for c in range(self.args.num_classes):
                ...
                if len(class_index) == 0:
                    continue
                test_data_folder = 'test_data/iter_{}/search_{}'.format(self.args.iter, c)
                ...
                #                        DiversityCalculator(features_matrix, size, device='cuda')]
                solver = MODE_Search(fitness_calculators=fitness_calculators, total_gene_num=len(class_index), budget=size,
                               device='cuda',
        ...
        test_data_folder = 'test_data/iter_{}/search_{}'.format(self.args.iter, self.args.dataset)
        os.makedirs(test_data_folder, exist_ok=True)
