...
def YELP(data_path):
    ...
    mean = None
    std = None
    folder_name = os.path.join(data_path, 'YELP')
    ...
    dst_train = YELPDataSet(root=folder_name, word_2_index=vocab, train=True)
    num_classes = dst_train.num_classes
    class_names = dst_train.classes
    dst_test = YELPDataSet(root=folder_name, word_2_index=vocab, train=False)
    return channel, im_size, num_classes, class_names, mean, std, dst_train, dst_test

if __name__ == '__main__':
    YELP('/home/sample_selection/data')