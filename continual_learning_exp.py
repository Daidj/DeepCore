...
if __name__ == '__main__':
    ...
    wb.to_excel('./excel/data_cl_MOEA2_10_3.xlsx')
    ...
    # wb.append('备注', 0, "MOEA2, fraction: 0.1, model:LeNet, dataset: TinyMnist, MOEA2, last_layer, Info, ratio: 1.0, cosine, population: 10, iter: 20, step_rate: 0.1, mmd: 0.003 ")
    # wb.to_excel('./excel/data_cl_MOEA2_10.xlsx')
    print("end")
